...
function SystemAdminDashboard() {
  ...
  const adminActions = [
    ...
    { name: 'Manage Roles', path: '/admin/users', icon: <FaUserShield className="text-4xl text-green-500" />, description: 'Define roles and their permissions within the application.' },
